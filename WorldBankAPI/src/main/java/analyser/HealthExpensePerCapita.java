...
public class HealthExpensePerCapita extends Analyser {
	...
	public HealthExpensePerCapita(JsonArray jsonArray, int sizeOfResults, String country) {
		this.cumYear = 0;
		this.currYear = 0;
	...
	public double computeAvg(JsonArray jsonArray, int sizeOfResults) {
		...
		for (int i = 0; i < sizeOfResults; i++) {
			...
			System.out.println("Health Expenditure per capita for " + this.country + " in " + year + " is " + currYear);
