...
public class HospitalBedsAnalyser extends Analyser {
	...
	public HospitalBedsAnalyser(JsonArray jsonArray, int sizeOfResults, String country) {
		this.cumYear = 0;
		this.currYear = 0;
	...
	public double computeAvg(JsonArray jsonArray, int sizeOfResults) {
		...
		for (int i = 0; i < sizeOfResults; i++) {
			...
			System.out.println("Hospital beds (per 1,000 people) for " + this.country + " in " + year + " is " + currYear);
